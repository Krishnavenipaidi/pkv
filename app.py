...
PREDICTED_LABELS = ["americanshorthair","bengal","mainecoon","regdoll","scottishfold","sphinx"]  # edit 1
PREDICTED_LABELS.sort()

def get_prediction(image_data):
  #replace your image classification ai service URL
  url = 'https://askai.aiclub.world/a6b171d4-0c31-4e9f-b826-977717529c6b'  #Edit 2
...
st.title("Welcome to Cat Breeds Image Classifier Web App!")#change according to your project   #edit 3
...
with tab1:
  #setting up the title
  st.header("Cat Breeds Image Classifier")#change according to your project   #edit 3
...
with tab2:
  ...
  #add github link
  st.link_button("My Github Repository", "https://github.com/Krishnavenipaidi/pkv")
  ...
  pdf_url = "https://raw.githubusercontent.com/Krishnavenipaidi/pkv/main/report.pdf"
